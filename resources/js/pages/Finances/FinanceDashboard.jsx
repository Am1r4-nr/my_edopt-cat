...
// import { mockFinances } from '@/lib/mockData'; // Removed mock data
...
export default function FinanceDashboard() {
    ...
    const { metrics, revenue: revenueData, funds } = data;

    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Financial Oversight</h1>
                    ...
                    <CardContent className="p-6">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold mt-2">{metrics.total_revenue}</h3>
                            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold mt-2">{metrics.medical_fund}</h3>
                            </div>
                            <div className="p-3 bg-white bg-opacity-20 rounded-lg">
                                <ActivityIcon />
                            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold mt-2">{metrics.toyyibpay_balance}</h3>
                            </div>
                            <div className="p-3 bg-white bg-opacity-20 rounded-lg">
